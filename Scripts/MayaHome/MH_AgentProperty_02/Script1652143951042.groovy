...
Mobile.setText(findTestObject('MayaHome/mayahome - MobileSpy 1/propertyagent - Txtfield'), findTestData('propertyDetails').getValue(
        2, 1), 0)

def staffNumber2 = Mobile.getText(findTestObject('MayaHome/mayahome - MobileSpy 4/staffNumberEnter - Txt'), 0)

Mobile.tap(findTestObject('MayaHome/mayahome - MobileSpy 5/confirm - Btn'), 0)

Mobile.waitForElementPresent(findTestObject('MayaHome/mayahome - MobileSpy 4/staffNameHeader - Txt'), 30, FailureHandling.CONTINUE_ON_FAILURE)
...
Mobile.verifyElementText(findTestObject('MayaHome/mayahome - MobileSpy 4/staffNumberReview - Txt'), staffNumber2, FailureHandling.CONTINUE_ON_FAILURE)
