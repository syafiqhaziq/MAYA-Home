...
Mobile.setText(findTestObject('MayaHome/mayahome - MobileSpy 1/searchproperties - editTxt'), '!@#$', 0)

Mobile.hideKeyboard()

Mobile.setText(findTestObject('MayaHome/mayahome - MobileSpy 1/searchproperties - editTxt'), '12345', 0)

Mobile.hideKeyboard()

Mobile.setText(findTestObject('MayaHome/mayahome - MobileSpy 1/searchproperties - editTxt'), 'Resi', 0)
