...
def propertypriceEnter = findTestData('mayahomeCredentials').getValue(4, 1)
...
def downpaymentEnter = findTestData('mayahomeCredentials').getValue(5, 1)
...
if (Mobile.verifyElementVisible(findTestObject('MayaHome/mayahome - MobileSpy 2/successStatement - Txt'), 0, FailureHandling.OPTIONAL)) {
    ...
    Mobile.verifyElementText(findTestObject('MayaHome/mayahome - MobileSpy 4/reviewApp - propertyLoanAmount(RM)'), loanAmount, 
        FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.verifyElementText(findTestObject('MayaHome/mayahome - MobileSpy 4/reviewApp - loanPeriod(year)'), loanPeriod, 
        FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.verifyElementText(findTestObject('MayaHome/mayahome - MobileSpy 4/reviewApp - propertyPrice(RM)'), propertyPrice, 
        FailureHandling.CONTINUE_ON_FAILURE)
    ...
    Mobile.verifyElementText(findTestObject('MayaHome/mayahome - MobileSpy 4/reviewApp - downpayment(RM)'), downpaymentPrice, 
        FailureHandling.CONTINUE_ON_FAILURE)
