...
//Mobile.setText(findTestObject('Login Onboarding/loginExistingUsernameInputField'), GlobalVariable.username, 0)
Mobile.setText(findTestObject('Login Onboarding/loginExistingUsernameInputField'), Username, 0)
...
Mobile.setText(findTestObject('Login Onboarding/onboardNameInputField'), 'Fadhlin', 0)
