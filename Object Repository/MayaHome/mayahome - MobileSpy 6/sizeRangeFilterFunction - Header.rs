...
<MobileElementEntity>
   ...
   <name>sizeRangeFilterFunction - Header</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Size Range' or . = 'Size Range')]</locator>
