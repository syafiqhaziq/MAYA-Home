...
<MobileElementEntity>
   ...
   <name>roomCarParkFilterFunction - Header</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Rooms &amp; Carparks' or . = 'Rooms &amp; Carparks')]</locator>
