...
<MobileElementEntity>
   ...
   <name>eligibilityDetails - PropertyNameTxt</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'EIGHTY FIVE AVENUE ' or . = 'EIGHTY FIVE AVENUE ')]</locator>
