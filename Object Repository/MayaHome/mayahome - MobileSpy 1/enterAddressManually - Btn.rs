...
<MobileElementEntity>
   ...
   <name>enterAddressManually - Btn</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Enter address manually' or . = 'Enter address manually')]</locator>
