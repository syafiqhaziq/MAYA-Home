...
<MobileElementEntity>
   ...
   <name>applyFinancingAIP - TitleHeader</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Apply Financing' or . = 'Apply Financing')]</locator>
