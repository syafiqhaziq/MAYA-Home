...
<MobileElementEntity>
   ...
   <name>viewApplicationAIP - Btn</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'View application' or . = 'View application')]</locator>
