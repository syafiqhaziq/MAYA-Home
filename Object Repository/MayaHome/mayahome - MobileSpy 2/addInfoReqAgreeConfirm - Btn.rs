...
<MobileElementEntity>
   ...
   <name>addInfoReqAgreeConfirm - Btn</name>
   <tag></tag>
   ...
   <locator>//*[@class = 'android.widget.TextView' and (@text = 'Agree and Confirm' or . = 'Agree and Confirm')]</locator>
